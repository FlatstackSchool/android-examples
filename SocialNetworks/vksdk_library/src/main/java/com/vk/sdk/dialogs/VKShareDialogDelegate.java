...
import com.vk.sdk.api.VKUploadWallPhotoRequest;
...
class VKShareDialogDelegate {
    ...
    private void makePostWithAttachments(VKAttachments attachments) {
        ...
        VKRequest wallPost = VKApi.wall().post(VKParameters.from(VKApiConst.OWNER_ID, userId,
            VKApiConst.MESSAGE, message,
            VKApiConst.ATTACHMENTS, attachments.toAttachmentsString()));
